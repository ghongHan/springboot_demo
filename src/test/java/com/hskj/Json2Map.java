...
public class Json2Map {
    ...
    public static void main(String[] args) {
        String para = "{'status':'OK'," +
                        ...
                        "}" +
                    "}";
        System.out.println(json2Map(para));
    ...
    public static Map<String, Object> json2Map(String jsonStr) {
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            if(entry.getValue() instanceof Map){
                resultMap = json2map1(entry, new HashMap<String, Object>());
            }else{
     ...
     * @return
     */
    public static Map<String, Object> json2map1(Map.Entry<String, Object> entry, Map<String, Object> resultMap) {
        if (entry.getValue() instanceof Map) {
            ...
            for (Map.Entry<String, Object> entry1 : map1.entrySet()) {
                if (entry1.getValue() instanceof Map) {
                    map1 = json2map1(entry1, resultMap);
                } else {
